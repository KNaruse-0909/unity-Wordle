...
public class Board : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        buttonImageColor = newWordButton.image.color;
    }
    ...
    private void Update()
    {
        ...
        else
        {
            for (int i = 0; i < SUPPORTED_KEYS.Length; i++)
            {
                ...
                {
                    //tileの移動。1フレームに1文字しか入力できないようにする処理
    ...
    private void SubmitRow(Row row)
    {
        ...
        //文字入力と指定wordと位置が合っているか、指定wordが含まれているかを確認。
        ...
        {
            enabled = false;
            newWordButton.image.color = Color.white;
    ...
    {
        newWordButton.image.color = buttonImageColor;
